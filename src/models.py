...
class User(db.Model):
    ...
    planetas_favoritos = db.relationship('PlanetasFavoritos', backref='usuario')  # Cambiado 'usuario_planetas'
    personajes_favoritos = db.relationship('PersonajesFavoritos', backref='usuario')  # Cambiado 'usuario_personajes'
...
class Planetas(db.Model):
    ...
    favoritos = db.relationship('PlanetasFavoritos', backref='planeta')  # Usando solo backref
...
class Personajes(db.Model):
    ...
    favoritos = db.relationship('PersonajesFavoritos', backref='personaje')  # Usando solo backref
